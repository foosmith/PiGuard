...
struct Preferences {
    fileprivate enum Key {
        static let piholes = "piholes" // Deprecated in PiGuard legacy 1.1
        static let piholesV2 = "piholesV2" // Deprecated in PiGuard legacy 1.2
...
extension UserDefaults {
    var piholes: [PiholeConnectionV4] {
        if let array = array(forKey: Preferences.Key.piholesV2), !array.isEmpty {
            // Migrate from PiGuard legacy v1.1 format to PiGuard legacy v1.2 format if needed
